...
# notice that RACE imports as an integer in {0,1,2}; we want it to be a factor
#h2o.factor(train.hex, '320')
#h2o.integer(train.hex, '320')

x_ignore = c("320", "0", "1")
myX = setdiff(colnames(train.hex), x_ignore)
train.glm = h2o.glm(x = myX, y = "320", data = train.hex, family = "binomial", nfolds = 10, alpha = 0.5)
